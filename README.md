# 📖 마나나(Mañana)_오늘의 날씨에 문학 한 구절을 그려내다
...
- 프로젝트 기획·컨셉 총괄
- 서버 API 설계 및 관리 (오너)
- iOS 앱 개발 (SwiftUI · 위젯 · Core Location)
- 데이터 저장 구조(DB) 설계
- 품질 검증(QA)
...
- 프로젝트 기획·컨셉 총괄
- iOS 앱 개발 (SwiftUI · 위젯 · Core Location)
- 외부 API 연동 (기상청) 및 클라이언트 로직
- Cloudflare Worker 프록시 설계·배포 (API 키 보안)
- 협업 관리 & 문서화

### ☁️ 추원지 (Frontend / Design)
- 프로젝트 기획·컨셉 총괄
- UI/UX 디자인 & 손그림 아트워크
- 화면 기획 · 디자인 시스템
- 사용자 플로우 설계
